    ...
    initialize: function () {
      ...
      const formHTML = `
        <div class="form-container" style="display: flex; justify-content: space-between;">
          ...
          <div style="width: 30%; border-radius: 5px; padding: 10px;">
            <form id="formRelatorioHistorico" style="width: auto; height: auto; margin: 0;">
          ...
          <div class="form-resultado" style="margin: auto;width: 100%;display: flex;justify-content: space-between;">
            <form id="formResultado" style="width: auto; height: auto; margin: 0;">
